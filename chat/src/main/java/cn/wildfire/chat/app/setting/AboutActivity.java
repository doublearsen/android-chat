...
public class AboutActivity extends WfcBaseActivity {
    ...
    public void intro() {
        WfcWebViewActivity.loadUrl(this, "外贸通功能介绍", "");
    }

    @OnClick(R.id.agreementOptionItemView)
    public void agreement() {
        WfcWebViewActivity.loadUrl(this, "外贸通用户协议", "http://wmtongs.com/wmtong_user_agreement.html");
    }

    @OnClick(R.id.privacyOptionItemView)
    public void privacy() {
        WfcWebViewActivity.loadUrl(this, "外贸通个人信息保护政策", "http://wmtongs.com/wmtong_user_privacy.html");
    }
}
